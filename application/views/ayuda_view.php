	...
	<div class="col-lg-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<?= heading('<i class="fa fa-users fa-fw"></i> Módulo de Usuarios', 2); ?>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						...
						echo tag('p', 'SYSCAP muestra el listado de estudiantes por: Nombre de Usuario, Nombre Completo, Número de DUI, Correo Electrónico y Centro Educativo.').br();
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<?= heading('<i class="fa fa-university fa-fw"></i> Módulo de Centros Educativos', 2); ?>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						...
						echo tag('p', 'Permite consultar Centros Educativos de capacitación de docentes, realizando búsquedas por: Código, Nombre, Departamento y Municipio.').br();
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<?= heading('<i class="fa fa-bar-chart-o fa-fw"></i> Módulo de Consultas Estadísticas', 2); ?>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						...
						echo tag('p', 'Método 1.');
						echo ul(array(
						'Desde la página de Inicio hacer doble clic al bóton '.tag('div', '<i class="fa fa-bar-chart-o fa-fw"></i> Módulo de Consultas Estadísticas <i class="caret"></i>', 'class="btn btn-sm btn-primary"').' .'
						)).br();
						echo tag('p', 'Método 2.');
						echo ul(array(
						'Desde el menú principal hacer doble clic a la opción '.tag('span', '<i class="fa fa-bar-chart-o fa-fw"></i> Módulo de Consultas Estadísticas', 'class="opcion_menu"').' .'
						)).br();
						echo heading('Realizar una Búsqueda.', 4);
						echo ol(array(
						'Dentro del resumen estadístico, seleccionar las opciones que se deseen con cualquier combinación. Todos los campos son opcionales para realizar una búsqueda estadística, a excepción de los campos de fecha del periodo:'.
						ol(array(
							'Si se selecciona un rango de fechas (fecha inicial y fecha final), tener en cuenta que la fecha inicial debe de ser diferente y menor a la fecha final.',
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<?= heading('<i class="fa fa-map-marker fa-fw"></i> Módulo de Mapa Estadístico', 2); ?>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						<?php
						echo tag('p', 'Muestra en el mapa de El Salvador el total de docentes de la modalidad de capacitación tutorizados y tipo de capacitado por departamento, municipio y centro educativo.').br();
