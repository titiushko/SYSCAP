...
<title><?= htmlentities(@$centro_educativo[0]->nombre_centro_educativo.' '. @$centro_educativo[0]->codigo_centro_educativo, ENT_COMPAT, 'UTF-8'); ?></title>
	   ...
	   <?= encabezado_reporte(); ?>
					...
					<tr>
						...
						<tr><td colspan="5"><?= nbs(); ?></td></tr>
							<tr>
								<th class="column-title">Departamento:</th><td class="column-value"><?= htmlentities(@$centro_educativo[0]->id_departamento, ENT_COMPAT, 'UTF-8'); ?></td>
								<td class="column-nbs"><?= nbs(); ?></td>
								<th class="column-title">Municipio:</th><td class="column-value"><?= htmlentities(@$centro_educativo[0]->id_municipio, ENT_COMPAT, 'UTF-8'); ?></td>
							</tr>
						</table>
					  <?= form_fieldset_close(); ?>
					Add a comment to this line
