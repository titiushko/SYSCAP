...
<html lang="en">
	...
	<body style="font-size: 12px;">
		...
		<fieldset>
			<legend><h3 align="center">Estadística de Usuarios a Nivel Nacional</h3></legend>
			<hr/>
			<table border="0">
				<tr>
					<td style="text-align: left; font-weight: bold; widtd: 60px;">Grado Digital:</td><td style="widtd: 60px;"><GRADO_DIGITAL></td>
		...
		<fieldset>
			<legend><h4>Listado de Certificaciones por Grado Digital</h4></legend>
			<hr/>
			<table border="1">
				<thead>
					<tr>
						<td style="text-align: center; font-weight: bold;">#</td>
						<td style="text-align: center; font-weight: bold;">Categor&iacute;a</td>
						<td style="text-align: center; font-weight: bold;">Curso</td>
						<td style="text-align: center; font-weight: bold;">Tutorizados</td>
						<td style="text-align: center; font-weight: bold;">Autoformaci&oacute;n</td>
					</tr>
				</thead>
